...
/*
  ...
  //  ],
    ...
    */
    ...
    //     'username' => 'authuser',
    //     'password' => 'MyNewPass5!'
    //     'query' => 'SELECT uid, userName, email, eduPersonPrincipalName FROM users WHERE uid = :username AND AES_DECRYPT(password,"MyNewPass5!") = :password',
    // ],
    ...
    */
	...
	'admin:1234' => [
            'uid' => ['admin@mail.dumail.com'],
            'eduPersonAffiliation' => ['member', 'admin'],
        ],
	'manager:1234' => [
            'uid' => ['manager@mail.dutmail.com'],
     ...
     'example-userpass' => [
        ...
        'employee:1234' => [
            'uid' => ['employee@mail.dumail.com'],
            'eduPersonAffiliation' => ['employee'],
        ],
    	'manager:1234' => [
            'uid' => ['manager@mail.dumail.com'],
            'eduPersonAffiliation' => ['manager'],
        ],
